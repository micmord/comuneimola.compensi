...
NAME_MAPPING = {'publication_type': 'Tipo di procedimento',
                'title': 'Soggetto/Oggetto/Beneficiario',
                'procedure_code': 'Procedimento numero',
                'office': 'Ufficio',
...
class CsvExport(BrowserView):
    ...
    def get_query(self):
        ...
        return {'portal_type': 'ATProcedimento190',
