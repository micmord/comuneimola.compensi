...
class IAreaProvvedimentiView(Interface):
    """
    areaprovvedimenti view interface
    """
...
class AreaProvvedimentiView(BrowserView):
    """
    areaprovvedimenti browser view
    """
    implements(IAreaProvvedimentiView)
